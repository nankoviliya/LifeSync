...
namespace LifeSync.API.Persistence.Migrations
{
    ...
    [Migration("20260509105113_AddTags")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LifeSync.API.Models.Tags.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LifeSync.API.Models.Tags.TagAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LifeSync.API.Models.Tags.TagAssignment", b =>
                {
                    b.HasOne("LifeSync.API.Models.Tags.Tag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
